...
public static string Combine_Crown () => Translator.inst.Translate("Combine_Crown", new() {});
public static string Combine_Crown_Tutorial (string Num) => Translator.inst.Translate("Combine_Crown_Tutorial", new() {("Num", Num)});
public static string Combine_Crown_Score (string Num) => Translator.inst.Translate("Combine_Crown_Score", new() {("Num", Num)});
...
public static string TrainTrack () => Translator.inst.Translate("TrainTrack", new() {});
